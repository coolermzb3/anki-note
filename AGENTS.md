...
- For ordinary code edits, do not run `pnpm run build` immediately after implementation. Run build before committing or submitting changes, or when a build-only failure needs investigation.
