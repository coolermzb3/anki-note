...
- Browser/UI verification is not required by default. Use test/build verification unless the user explicitly asks for browser verification or a browser-only failure needs reproduction.
